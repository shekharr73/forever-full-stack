    ...
    <div className="border-t-2 border-gray-200 pt-10 transition-opacity ease-in duration-500 opacity-100">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col gap-4 my-8">
            ...
            <div>
              ...
              <hr className="border-t border-gray-300 mt-8 sm:w-4/5" />
      ...
      <div className="mt-20">
        ...
        <p className="border border-gray-200 px-5 py-3 text-sm">Reviews (122)</p>
          ...
          <p>An e-commerce website is an online platform that facilitates the buying and selling of products or services over the internet, It serves as a virtual marketplace where businesses and individuals can showcase their products, interact with customers, and conduct fransactions without the need for a physical presence. E-commerce websites have gained immense popularity due to their convenience, accessibility, and the global reach they offer</p>
