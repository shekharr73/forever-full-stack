    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t border-gray-100">
      ...
      <div className="min-w-60">
        <p className="my-2 text-xl flex items-center cursor-pointer gap-2">
          FILTERS
          <img onClick={() => setShowFilter(!showFliter)} className={`h-3 sm:hidden ${showFliter ? "rotate-90" : ""}`} src={assets.dropdown_icon} alt="" />
        </p>
        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFliter ? "" : "hidden"} sm:block`}>
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gary-7">
            <p className="flex flex-col gap-2 text-sm font-light text-gray-700">
